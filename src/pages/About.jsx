          ...
          <ul className='timeline'>
              ...
              <div className='timeline-panel'>
                ...
                <div className='timeline-body'>
                  <p className='text-muted'>
                    Todo nació como un sueño de cada uno de nosotros, donde las ideas y profesiones se complementaron dando esto como resultado el mejor
                    restaurante.
                  </p>
                </div>
              </div>
            ...
            <li>
              ...
              <div className='timeline-panel'>
                ...
                <div className='timeline-body'>
                  <p className='text-muted'>
                    Abrimos este gran sueño siendo un logro fundamental para la vida de cada uno de nosotros, cada día con nuestro servicio les queremos brindar
                    y trasmitir la misma pasión por la cocina y el amor a las pastas y así lograr que se sientan en un lugar lleno de amor y paz.
                  </p>
                </div>
              </div>
            </li>
            <li className='timeline-inverted'>
              ...
              <div className='timeline-panel'>
                ...
                <div className='timeline-body'>
                  <p className='text-muted'>
                    Luego de cumplir nuestro primer sueño, se fue creando otra meta que en el 2021 fue posible, este año ha sido lleno de muchas experiencias,
                    donde se ha hecho realidad la inauguración nuestro segundo restaurante, siendo esto un motor fundamental para cada día brindarles lo mejor.
                  </p>
                </div>
              </div>
            </li>
